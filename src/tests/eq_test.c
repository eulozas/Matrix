...
START_TEST(eq_corr_f3) {
    ...
    matrix_t B;
    s21_create_matrix(3, 3, &A);
    double arr1[] = {2.123347, 5.0, 7.0, 6.0, 3.0, 4.0, 5.0, -2.0, -3.0};
    s21_init_matrix(&A, arr1);
    s21_create_matrix(3, 3, &B);
    double arr2[] = {2.123346, 5.0, 7.0, 6.0, 3.0, 4.0, 5.0, -2.0, -4.0};
    s21_init_matrix(&B, arr2);
    ck_assert_int_eq(s21_eq_matrix(&A, &B), FAILURE); 
    s21_remove_matrix(&A);
    s21_remove_matrix(&B);
...
START_TEST(eq_corr_f4) {
    ...
    double arr1[] = {2.123340};
    s21_init_matrix(&A, arr1);
    s21_create_matrix(1, 1, &B);
    double arr2[] = {2.123341};
    s21_init_matrix(&B, arr2);
    ck_assert_int_eq(s21_eq_matrix(&A, &B), FAILURE); 
    s21_remove_matrix(&A);
    s21_remove_matrix(&B);
...
START_TEST(eq_corr_f5) {
    ...
    matrix_t B;
    s21_create_matrix(1, 1, &A);
    double arr1[] = {3.123340};
    s21_init_matrix(&A, arr1);
    s21_create_matrix(1, 1, &B);
    double arr2[] = {2.123340};
    s21_init_matrix(&B, arr2);
    ck_assert_int_eq(s21_eq_matrix(&A, &B), FAILURE); 
    s21_remove_matrix(&A);
    s21_remove_matrix(&B);
...
START_TEST(eq_corr_f6) {
    ...
    matrix_t B;
    s21_create_matrix(1, 1, &A);
    double arr1[] = {-20.123349};
    s21_init_matrix(&A, arr1);
    s21_create_matrix(1, 1, &B);
    double arr2[] = {-20.123343};
    s21_init_matrix(&B, arr2);
    ck_assert_int_eq(s21_eq_matrix(&A, &B), FAILURE); 
    s21_remove_matrix(&A);
    s21_remove_matrix(&B);
...
START_TEST(eq_corr1) {
    ...
    matrix_t B;
    s21_create_matrix(3, 3, &A);
    double arr1[] = {2.0, 5.0, 7.12345, 6.0, 3.0, 4.0, 5.0, -2.0, -3.1234561};
    s21_init_matrix(&A, arr1);
    s21_create_matrix(3, 3, &B);
    double arr2[] = {2.0, 5.0, 7.12345, 6.0, 3.0, 4.0, 5.0, -2.0, -3.1234569};
    s21_init_matrix(&B, arr2);
...
START_TEST(eq_corr2) {
    ...
    double arr1[] = {0.012345999, 5.0, 7.12345, 6.0, 3.0, 4.0};
    s21_init_matrix(&A, arr1);
    s21_create_matrix(2, 3, &B);
    double arr2[] = {0.01234511111, 5.0, 7.12345, 6.0, 3.0, 4.0};
    s21_init_matrix(&B, arr2);
    ck_assert_int_eq(s21_eq_matrix(&A, &B), SUCCESS); 
    s21_remove_matrix(&A);
    s21_remove_matrix(&B);
...
START_TEST(eq_corr4) {
    ...
    matrix_t B;
    s21_create_matrix(1, 1, &A);
    double arr1[] = {123.99999999};
    s21_init_matrix(&A, arr1);
    s21_create_matrix(1, 1, &B);
    double arr2[] = {123.999999111};
    s21_init_matrix(&B, arr2);
    ck_assert_int_eq(s21_eq_matrix(&A, &B), SUCCESS); 
    s21_remove_matrix(&A);
    s21_remove_matrix(&B);
...
START_TEST(eq_corr6) {
    ...
    matrix_t B;
    s21_create_matrix(1, 1, &A);
    double arr1[] = {-0.555556999};
    s21_init_matrix(&A, arr1);
    s21_create_matrix(1, 1, &B);
    double arr2[] = {-0.555556000};
    s21_init_matrix(&B, arr2);
    ck_assert_int_eq(s21_eq_matrix(&A, &B), SUCCESS); 
    s21_remove_matrix(&A);
    s21_remove_matrix(&B);
